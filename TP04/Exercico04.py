...
def sierpinski():
    ...
    plt.axis('off')
    caminho = os.path.join(os.path.expanduser("~"), "Desktop", "sierpinski.png")
    plt.savefig(caminho, bbox_inches='tight', dpi=300)
    plt.close()
    print(f"Fractal 'sierpinski' salvo em: {caminho}")
...
def samambaia_barnsley():
    ...
    plt.axis('off')
    caminho = os.path.join(os.path.expanduser("~"), "Desktop", "samambaia_barnsley.png")
    plt.savefig(caminho, bbox_inches='tight', dpi=300)
    plt.close()
    print(f"Fractal 'samambaia_barnsley' salvo em: {caminho}")
...
def mandelbrot(width=800, height=800, max_iter=100):
    ...
    plt.axis('off')
    caminho = os.path.join(os.path.expanduser("~"), "Desktop", "mandelbrot.png")
    plt.savefig(caminho, bbox_inches='tight', dpi=300)
    plt.close()
    print(f"Fractal 'mandelbrot' salvo em: {caminho}")
...
def julia(c=-0.7 + 0.27015j, width=800, height=800, max_iter=100):
    ...
    plt.axis('off')
    caminho = os.path.join(os.path.expanduser("~"), "Desktop", "julia.png")
    plt.savefig(caminho, bbox_inches='tight', dpi=300)
    plt.close()
    print(f"Fractal 'julia' salvo em: {caminho}")
...
def koch_curve(order=4, size=300):
    ...
    plt.axis('equal')
    plt.axis('off')
    caminho = os.path.join(os.path.expanduser("~"), "Desktop", "koch_curve.png")
    plt.savefig(caminho, bbox_inches='tight', dpi=300)
    plt.close()
    print(f"Fractal 'koch_curve' salvo em: {caminho}")
...
def fractal_tree():
    ...
    plt.axis('equal')
    plt.axis('off')
    caminho = os.path.join(os.path.expanduser("~"), "Desktop", "fractal_tree.png")
    plt.savefig(caminho, bbox_inches='tight', dpi=300)
    plt.close()
    print(f"Fractal 'fractal_tree' salvo em: {caminho}")
...
def sierpinski_carpet(size=3, iterations=4):
    ...
    plt.axis('off')
    caminho = os.path.join(os.path.expanduser("~"), "Desktop", "sierpinski_carpet.png")
    plt.savefig(caminho, bbox_inches='tight', dpi=300)
    plt.close()
    print(f"Fractal 'sierpinski_carpet' salvo em: {caminho}")
...
def menger_sponge(iterations=2):
    ...
    caminho = os.path.join(os.path.expanduser("~"), "Desktop", "menger_sponge.png")
    plt.savefig(caminho, bbox_inches='tight', dpi=300)
    plt.close()
    print(f"Fractal 'menger_sponge' salvo em: {caminho}")
...
def gerar_todos_fractais_threads():
    fractais = [
        ("sierpinski", sierpinski),
        ("samambaia_barnsley", samambaia_barnsley),
    ...
    threads = []
    for nome, func in fractais:
        print(f"Iniciando thread para {nome}...")
...
def main():
    print("Gerando fractais sequencialmente...")
    inicio_seq = time.perf_counter()
    gerar_todos_fractais()
    fim_seq = time.perf_counter()
    print(f"Tempo de execução sequencial: {fim_seq - inicio_seq:.2f} segundos\n")
    
    print("Gerando fractais em paralelo (com threads)...")
    inicio_thread = time.perf_counter()
    gerar_todos_fractais_threads()
    fim_thread = time.perf_counter()
    print(f"Tempo de execução com threads: {fim_thread - inicio_thread:.2f} segundos")
